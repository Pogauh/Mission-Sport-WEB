 ...
 */
final class Version20240227172004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ajouter ADD produit_id INT DEFAULT NULL, ADD panier_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ajouter DROP produit_id, DROP panier_id');
    }
}
