 ...
 */
final class Version20240227171003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ajouter DROP article_id, DROP panier_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE ajouter ADD article_id INT DEFAULT NULL, ADD panier_id INT DEFAULT NULL');
